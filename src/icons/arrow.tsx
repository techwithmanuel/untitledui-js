...
export const ArrowBlockDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowBlockRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowBlockLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowBlockUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleBrokenUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowCircleUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowNarrowUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowSquareUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowsDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowsLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowsRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowsTriangle: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ArrowsUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronDownDouble: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
        d="M6 9L12 15L18 9"
...
export const ChevronLeftDouble: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
        d="M15 18L9 12L15 6"
...
export const ChevronRightDouble: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
        d="M9 18L15 12L9 6"
...
export const ChevronSelectorHorizontal: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronSelectorVertical: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronUpDouble: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const ChevronUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
        d="M18 15L12 9L6 15"
...
export const CornerDownLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerDownRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerLeftDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerLeftUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerRightDown: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerRightUp: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerUpLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const CornerUpRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand01: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand02: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand03: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand04: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand05: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Expand06: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const FlipBackward: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const FlipFoward: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const Infinity: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCCW01: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCCW02: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCCW03: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCCW04: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCW01: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCW02: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCW03: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCW04: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshCW05: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshLeft: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const RefreshRight: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const SwitchHorizontal01: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const SwitchHorizontal02: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const SwitchVertical01: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
...
export const SwitchVertical02: SVGComponentProps = ({ ...props }) => {
  return (
    <SVG {...props}>
      <path
